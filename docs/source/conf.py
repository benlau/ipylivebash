...
# -*- coding: utf-8 -*-
#
# ipylivebash documentation build configuration file
#
...
_version_py = os.path.join(repo, 'ipylivebash', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'ipylivebashdoc'
...
latex_documents = [
    (master_doc, 'ipylivebash.tex', 'ipylivebash Documentation',
     'Ben lau', 'manual'),
]
